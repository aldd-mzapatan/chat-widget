...
var ChatBubble = class {
  ...
  _buildHistoryItem(session, isActive = false) {
    ...
    item.className = isActive ? "cb-history-item cb-history-item--active" : "cb-history-item";
    ...
    item.innerHTML = `
      ...
      ${isActive ? "" : `<button class="cb-history-item-delete" aria-label="Eliminar conversaci\xF3n" title="Eliminar conversaci\xF3n">
        ${ICONS.trash}
      </button>`}
    `;
    if (isActive)
